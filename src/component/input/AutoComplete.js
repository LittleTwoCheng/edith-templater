...
import { safeRegExp } from "../../core/regExp";
...
const defaultRenderSuggestion = (suggestion, inputValue) => (
  <Fragment>
    <PhaseHighlight highlight={inputValue}>{suggestion.label}</PhaseHighlight>
    {suggestion.tags && suggestion.tags.length ? (
      <Fragment>
        {"  "}
        <Chips list={suggestion.tags} Component={null} variant="outlined" />
      </Fragment>
    ) : null}
  </Fragment>
);
